        ...
        <section className="pt-32 pb-20 px-4 bg-gradient-to-b from-primary/20 to-white">
            <div className="container mx-auto text-center max-w-4xl">
                ...
                <div className="mt-4 flex justify-center">
                    <a href="sms:+18123105480" className="inline-flex items-center gap-2 text-sm font-medium text-slate-500 hover:text-primary transition-colors hover:underline underline-offset-4">
